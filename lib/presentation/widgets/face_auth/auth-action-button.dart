...
class _AuthActionButtonState extends State<AuthActionButton> {
  ...
  Future _signUp(context) async {
    ...
    TrabajadorModel userToSave = TrabajadorModel(
      user: user,
      password: password,
  ...
  Future _signIn(context) async {
    ...
    if (predictedUser!.password == password) {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (BuildContext context) => const EmpleadosScreen()));
    } else {
      showDialog(
        context: context,
        builder: (context) {
  ...
  Future<TrabajadorModel?> _predictUser() async {
    TrabajadorModel? userAndPass = await _mlService.predict();
    return userAndPass;
  }
